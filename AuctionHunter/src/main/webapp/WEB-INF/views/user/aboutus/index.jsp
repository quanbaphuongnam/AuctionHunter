...
<mt:layout_user title="aboutus">
	<jsp:attribute name="content">
        ...
        <div class="container">
            ...
            <div class="row">
            	<div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img class="blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/about1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/about1.jpg" alt="About Us" /></div>
                <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img class="blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/about2.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/about2.jpg" alt="About Us" /></div>
                <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img class="blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/about3.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/about3.jpg" alt="About Us" /></div>
            </div>
            <div class="row">
            	<div class="col-12">
