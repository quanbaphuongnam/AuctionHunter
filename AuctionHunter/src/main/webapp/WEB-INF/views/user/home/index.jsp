	...
	<jsp:attribute name="content">
    	...
    	<div class="collection-header">
			<div class="collection-hero">
        		<div class="collection-hero__image"><img class="blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/cat-women.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/cat-women.jpg" alt="Women" title="Women" /></div>
            	...
            	<div class="col-12 col-sm-12 col-md-3 col-lg-3 sidebar filterbar">
                	...
                	<div class="sidebar_tags">
                        ...
                        <div class="sidebar_widget static-banner">
                        	<img src="${pageContext.request.contextPath }/resources/user/assets/images/side-banner-2.jpg" alt="" />
                        </div>
                        <!--Banner-->
                        <!--Information-->
                        <div class="sidebar_widget">
                            	...
                            	<div class="row">
                                	<div class="col-4 col-md-4 col-lg-4 filters-toolbar__item collection-view-as d-flex justify-content-start align-items-center">
                                    	<a href="shop-left-sidebar.html" title="Grid View" class="change-view change-view--active">
                                        	<img src="${pageContext.request.contextPath }/resources/user/assets/images/grid.jpg" alt="Grid" />
                                        </a>
                                        <a href="shop-listview.html" title="List View" class="change-view">
                                        	<img src="${pageContext.request.contextPath }/resources/user/assets/images/list.jpg" alt="List" />
                                        </a>
                                    </div>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image17-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image17-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                            <!-- product label -->
                                            <div class="product-labels"><span class="lbl on-sale">Sale</span></div>
                                            <!-- End product label -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image18-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image18-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <!-- Variant -->
                                        <ul class="swatches">
                                            <li class="swatch medium rounded"><img src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/variant5-1.jpg" alt="image" /></li>
                                            <li class="swatch medium rounded"><img src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/variant5-1.jpg" alt="image" /></li>
                                            <li class="swatch medium rounded"><img src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/variant5-1.jpg" alt="image" /></li>
                                            <li class="swatch medium rounded"><img src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/variant5-1.jpg" alt="image" /></li>
                                        </ul>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image19-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image19-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image20-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image20-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                            <!-- product label -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image21-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image21-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image22-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image22-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image23-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image23-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image24-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image24-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image25-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image25-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image26-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image26-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item grid-view-item--sold-out">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="grid-view-item__image hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image27-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image27-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image28-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image28-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image29-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image29-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image30-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image30-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="${pageContext.request.contextPath }/product/productdetail">
                                            ...
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image31-1.jpg" src="${pageContext.request.contextPath }/resources/user/assets/images/product-images/product-image31-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
