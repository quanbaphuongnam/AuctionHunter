...
public class HomeController implements ServletContextAware {
	...
	public String category(@PathVariable("id") int id, ModelMap modelMap, Authentication authentication,
...
//			}
	...
	public String brand(@PathVariable("id") int id, ModelMap modelMap, Authentication authentication,
			HttpServletRequest request) {
