    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
            	<a href="${pageContext.request.contextPath }/admin"> <img class="main-logo" src="${pageContext.request.contextPath }/resources/user/assets/images/logo_text.png" width="200" height="100"></a>
                <strong><img src="${pageContext.request.contextPath }/resources/user/assets/images/logo_icon.png" alt="" /></strong>
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="${pageContext.request.contextPath }/home"><img src="${pageContext.request.contextPath} /resources/user/assets/images/logo_icon.png" alt="" /></a>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href=""><span class="mini-sub-pro">Analytics </span></a></li>
                                <li><a title="Dashboard v.2" href="${pageContext.request.contextPath }/accountadmin/add"><span class="mini-sub-pro">Analytics </span></a></li>
                            </ul>
                        </li>
                        <li>
