...
<div class="pageWrapper">
                ...
                <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                	...
                	<nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                        ...
                        <li class="lvl1 parent dropdown"><a href="#">Account <i class="anm anm-angle-down-l"></i></a>
                          <ul class="dropdown">
                            <li><a href="${pageContext.request.contextPath }/account/index" class="site-nav">Profile</a></li>
                            ...
                            <div class="total">
                                <div class="total-in">
                                 ...
                                 <div class="buttonSet text-center">
                                    <a href="${pageContext.request.contextPath }/cart" class="btn btn-secondary btn--small">View Cart</a>
                                    <a href="${pageContext.request.contextPath }/cart/checkout" class="btn btn-secondary btn--small">Checkout</a>
                                </div>
                            </div>
                        </div>
                        <!--End Minicart Popup-->
    ...
    <div class="mobile-nav-wrapper" role="navigation">
        ...
        <ul id="MobileNav" class="mobile-nav">
        	<li class="lvl1 parent megamenu"><a href="${pageContext.request.contextPath }/home">Home <i class="anm anm-plus-l"></i></a>
          
        </li>
        	<li class="lvl1 parent megamenu"><a href="${pageContext.request.contextPath }/aboutus">About Us <i class="anm anm-plus-l"></i></a>
          
        </li>
        	<li class="lvl1 parent megamenu"><a href="${pageContext.request.contextPath }/contactus">Contact Us <i class="anm anm-plus-l"></i></a>
          
        </li>
        	<li class="lvl1 parent megamenu"><a href="about-us.html">FAQs <i class="anm anm-plus-l"></i></a>
