                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <table>
                               ...
                               <c:forEach var="findAccount"
									items="${findAccounts }">
                                <tr>
                                     <td>${findAccount.id }</td>
                                     <td>${findAccount.username }</td>
                                      <td>${findAccount.fullName }</td>
                                       <td>${findAccount.sex }</td>
                                        <td>${findAccount.email }</td>
                                         <td>${findAccount.phone }</td>
                                         <td>${findAccount.address }</td>
                                    <td> <fmt:formatDate var="day" value="${findAccount.dob }" pattern="dd/MM/yyyy" />${day }</td>
                                     

									
                                    
                                    <td><c:choose> <c:when
													test="${findAccount.isDelete==true }">
                                    <button class="pd-setting">Active</button>
                                    </c:when>
                                    <c:when
													test="${findAccount.isDelete==false }">
