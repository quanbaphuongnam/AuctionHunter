...
<mt:layout_user title="account">
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/resources/user/profile/css/style.css">
				...
				<div class="profile-tab-nav border-right">
					<div class="p-4">
						<div class="img-circle text-center mb-3">
							<img src="${pageContext.request.contextPath }/resources/user/profile/img/user2.jpg" alt="Image" class="shadow">
						</div>
						<h4 class="text-center">Tên như c</h4>
					</div>
					...
					<div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
								  	<label>Email</label>
								  	<input type="text" class="form-control" value="daxua@gmail.com">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
								  	<label>Address</label>
								  	<input type="text" class="form-control" value="23 nguyen dinh chieu">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
