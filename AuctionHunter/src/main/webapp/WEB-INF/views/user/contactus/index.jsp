...
- 285 Doi Can, Ba Dinh, Hanoi</p>
                            ...
                            <p><a href="https://www.google.com/maps/dir//212,+214+Nguy%E1%BB%85n+%C4%90%C3%ACnh+Chi%E1%BB%83u,+Ph%C6%B0%E1%BB%9Dng+6,+Qu%E1%BA%ADn+3,+Th%C3%A0nh+ph%E1%BB%91+H%E1%BB%93+Ch%C3%AD+Minh,+Vi%E1%BB%87t+Nam/@10.7787052,106.6903679,19.5z/data=!4m8!4m7!1m0!1m5!1m1!1s0x31752f3a9dbfeacd:0xd650f03fc37220b5!2m2!1d106.690024!2d10.7787258" class="btn btn--secondary btn--small" target="_blank">Get directions</a></p>
                        </div>
                   	</div>
                </div>
            </div>
...
Auction Hunter auctions mainly products about world fashion. Unique, unusual, rare and limited items or share your passion for fashion with the world.</p>
                	<div class="formFeilds contact-form form-vertical">
                      <form action="http://annimexweb.com/items/belle/${pageContext.request.contextPath }/resources/user/assets/php/mail.php" method="post"  id="contact_form" class="contact-form">	
                      <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <ul class="addressFooter">
                        <li><i class="icon anm anm-map-marker-al"></i><p>- 212-214 Nguyen Dinh Chieu, District 3 , HCMC <br/>- 54 - 56 Le Thanh Nghi, Hai Ba Trung, Hanoi <br/>- 285 Doi Can, Ba Dinh, Hanoi</p></li>
                        <li class="phone"><i class="icon anm anm-phone-s"></i><p>(440) 000 000 0000</p></li>
                        <li class="email"><i class="icon anm anm-envelope-l"></i><p>Gumsupper40@gmail.com <br/> Daitran477@gmail.com <br/> Bao0924327813@gmail.com </p></li>
                    </ul>
                    <hr />
